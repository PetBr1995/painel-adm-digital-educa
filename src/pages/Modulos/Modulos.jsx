...
export const Modulos = () => {
  ...
  const fetchCursoById = async (id) => {
    try {
      const response = await axios.get(`https://testeapi.digitaleduca.com.vc/curso/${id}`, {
        headers: {
  ...
  const handleDeleteModulo = async (moduloId) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        axios.delete(`https://testeapi.digitaleduca.com.vc/modulo-curso/${moduloId}`, {
          headers: {
            Authorization: `Bearer ${localStorage.getItem("token")}`
          }
        })
  ...
  const handleDeleteVideo = async (videoId) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        axios.delete(`https://testeapi.digitaleduca.com.vc/video/${videoId}`, {
          headers: {
            Authorization: `Bearer ${localStorage.getItem("token")}`
          }
        })
