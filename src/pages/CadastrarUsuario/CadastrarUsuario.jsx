...
const CadastrarUsuario = () => {
  ...
  const cadastrarUsuario = () => {
    ...
    // segurança extra: corta e trim antes de enviar
    const nomeSafe = nome.slice(0, MAX_NOME).trim();
    const emailSafe = email.slice(0, MAX_EMAIL).trim();
    const senhaSafe = senha.slice(0, MAX_SENHA);
        ...
        <Box sx={{ p: 4 }}>
          <Grid container spacing={3}>
            ...
            <TextField
              ...
              value={nome}
              onChange={(e) =>
                setNome(e.target.value.slice(0, MAX_NOME))
              }
              helperText={`${nome.length}/${MAX_NOME} caracteres`}
            ...
            <TextField
              ...
              required
              helperText={`${email.length}/${MAX_EMAIL} caracteres`}
            ...
            {/* Data Inicio e Fim */}
            <Box sx={{ display: "flex", gap: "1rem", width: "100%", mt: 2 }}>
              <TextField
                label="Data Início"
                type="datetime-local"
                fullWidth
            ...
            <TextField
              ...
              value={senha}
              onChange={(e) =>
                setSenha(e.target.value.slice(0, MAX_SENHA))
              }
              required
              helperText={`${senha.length}/${MAX_SENHA} caracteres`}
              inputProps={{ maxLength: MAX_SENHA }}
              InputProps={{
                startAdornment: (
                  <InputAdornment position="start">
          ...
          >
            ...
            <Button
              ...
              sx={{
                borderRadius: 3,
                background:
                  "linear-gradient(45deg, #FDBB30 30%, #f4a000 90%)",
                color: "#000",
                fontWeight: 700,
                px: 4,
                py: 1.2,
                ...
                "&:hover": {
                  background:
                    "linear-gradient(45deg, #f4a000 30%, #e89000 90%)",
