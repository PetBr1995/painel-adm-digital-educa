...
const Dashboard = () => {
  ...
  const getCursos = () => {
    return axios
      .get("http://10.10.11.174:3000/conteudos", {
        headers: {
  ...
  const getConteudos = () => {
    axios.get('http://10.10.11.174:3000/conteudos', {
      headers: {
        Authorization: `Bearer ${localStorage.getItem("token")}`
      }
  ...
  const getInstrutores = () => {
    return axios.get("http://10.10.11.174:3000/instrutor", {
      headers: {
        Authorization: `Bearer ${localStorage.getItem("token")}`,
      },
    }).then((response) => {
  ...
  const getCategorias = () => {
    return axios.get('http://10.10.11.174:3000/categorias/list')
      .then((response) => {
  ...
  const getPlanos = () => {
    return axios.get('http://10.10.11.174:3000/planos', {
      headers: {
        Authorization: `Bearer ${localStorage.getItem('token')}`
      }
    }).then((response) => {
